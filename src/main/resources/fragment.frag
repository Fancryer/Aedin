#version 330 core // fragment.frag
...
uniform vec3 viewPos, objectColor;
uniform float exposure, roughness, metallic;

// IBL
uniform samplerCube irradianceMap, prefilterMap;
uniform sampler2D brdfLUT;

const float PI = 3.14159265359, MAX_REFLECTION_LOD = 4.0;
...
//    float roughness = 0.9;
    ...
    float lod = roughness * MAX_REFLECTION_LOD; //lod = max(lod, 0.5);
